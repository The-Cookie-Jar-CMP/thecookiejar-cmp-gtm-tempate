...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "The Cookie Jar - CMP",
  "categories": [
    "TAG_MANAGEMENT",
    "PERSONALIZATION"
  ],
...
// Push dataLayer event signaling success.
...
const onSuccess = () => {
  main();
  // Set window to show SDK has loaded.
  let currentWindow = copyFromWindow('theCookieJar');
  currentWindow.isSDKLoaded = true;
  setInWindow('theCookieJar', currentWindow, true);
  // Push dataLayer object saying window hass loaded.
  dataLayerPush({'event': 'theCookieJarInitialised'});
...
Created on 8/17/2024, 2:18:59 PM
